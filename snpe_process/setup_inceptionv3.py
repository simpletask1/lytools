...
def prepare_data_images(snpe_root, model_dir, tensorflow_dir):
    ...
    create_raws_script = os.path.join(scripts_dir, 'create_raws.py')
...
def setup_assets(inception_v3_data_dir, download, runtime, udo, enable_htp):
    ...
    if udo:
        is_quantized = False
        UDO.setup_udo(model_dir, runtime, is_quantized, enable_htp)
        ...
        UDO.setup_udo(udo_quantized_package_path, runtime, not is_quantized, enable_htp)
