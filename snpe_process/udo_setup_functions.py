...
def set_udo_impl(udo_package_path, is_quantized, enable_htp):
    ...
    impl_libs = [os.path.join('CPU', 'SoftmaxImplLibCpu.cpp'), os.path.join('GPU', 'SoftmaxImplLibGpu.cpp')]
    package_libs = [os.path.join('CPU', 'SoftmaxImplLibCpu.cpp'), os.path.join('GPU', 'SoftmaxImplLibGpu.cpp')]
